    ...
    if (typeInfo === 'general') {
        ...
        <article className={styles.card}>
            ...
            <div className={styles.info}>
                <h2 className={`${styles.number} text text_type_main-default`}>{`#${number}`}</h2>
                <FormattedDate className={`${styles.date} text text_type_main-small text_color_inactive`} date={new Date(timestamp)} />
            </div>
